...
```{r xyplot, echo=TRUE}
library(lattice)
xyplot(steps~interval, weekday_averages, type = 'l', main = 'Weekdays')
xyplot(steps~interval, weekday_averages, type = 'l', main = 'Weekends')
...
xyplot(steps~interval | category, imputed_averages, type='l', layout=c(1,2))
```
